...
const SearchModal = () => {
    ...
    }, [bathroomCount, dateRange, guestCount, location, params, roomCount, router, searchModal, step]);
    ...
    if (step === STEPS.INFO) {
        bodyContent = (
            <div className='flex flex-col gap-8'>
                ...
                <Counter title='Guest' subtitle='How many guests are coming?' value={guestCount} onChange={(value) => setGuestCount(value)} />
